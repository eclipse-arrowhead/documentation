...
A system is a \GlossaryHyperRef{communication}{communicating} \GlossaryHyperRef{instance-software}{software instance} that \GlossaryHyperRef{provision-service}{provides} \textit{services}, each of which is a set of related \GlossaryHyperRef{operation-service}{operations} that system can execute.
...
Service operations can be executed, or \GlossaryHyperRef{consumption-service}{\textit{consumed}}, by the systems itself, other systems, or \GlossaryHyperRef{person}{persons} via \GlossaryHyperRef{interface-human}{human interfaces}.
