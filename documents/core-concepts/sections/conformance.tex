...
\item Every concept taken from this work must be represented by the name it is given here.
	...
	\item Note that some concepts defined here are given more than one name. When synonyms exist, only one of their entries in the glossary will have a definition. The name of that entry should be the name being used by the derived work.
	\end{enumerate}
