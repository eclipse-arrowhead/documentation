...
Here, we present the core concepts of the \GlossaryHyperRef{framework-arrowhead}{Arrowhead framework}.
Each subsection \GlossaryHyperRef{description}{describes} one primary concept, which are as follows:
