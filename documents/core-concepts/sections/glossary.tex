...
An \GlossaryHyperRef{implementation}{implementation} comprised of \GlossaryHyperRef{component-software}{software components}.

\GlossaryEntry{implementation-hardware}{Implementation, Hardware}
An \GlossaryHyperRef{implementation}{implementation} comprised of \GlossaryHyperRef{component-hardware}{hardware components}.
...
A set of \GlossaryHyperRef{constraint}{constraints} superimposed on a \GlossaryHyperRef{protocol}{protocol}.
	...
	\GlossaryNote{Note 1}{
		...
		It adds constraints to the existing messages or states of a protocol.
	}
...
\GlossaryEntry{system-of-local-clouds}{System-of-Local-Clouds}
X

\GlossaryEntry{system-of-systems}{System-of-systems}
X
...
% 		See Section \ref{sec:concepts:protocol} for more details.
% 	}
