...
At that and every other leftward stage, the message may be tested against the \GlossaryHyperRef{state-protocol}{protocol state} and/or policies expected to be enforced by the corresponding interfaces of the target.
