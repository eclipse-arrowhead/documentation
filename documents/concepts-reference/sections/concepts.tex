...
& \ref{sec:concepts:semantics}   & \textbf{\nameref{sec:concepts:semantics}}   & A \GlossaryHyperRef{model}{model} used interpret \GlossaryHyperRef{decode}{decoded} \GlossaryHyperRef{data}{data}. \\
...
A \GlossaryHyperRef{semantics}{semantics} is a \GlossaryHyperRef{model}{model} used to interpret \GlossaryHyperRef{data}{data} of one or more supported \GlossaryHyperRef{type-data}{types}.
...
This means that it is possible to \GlossaryHyperRef{encode}{encode} the same semantical, or abstract, data using several different data types.
...
Because of this property, it becomes possible to formulate \GlossaryHyperRef{profile-semantic}{semantic profiles}.
A semantic profile is a special kind of \GlossaryHyperRef{profile}{profile} that requires that more than one \GlossaryHyperRef{protocol}{protocol} use \GlossaryHyperRef{encoding}{encodings} whose fundamental data type all have the same semantics.