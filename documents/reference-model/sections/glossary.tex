...
A task, of any nature, that can be performed by a \GlossaryHyperRef{device}{device}.
	...
	\GlossaryNote{SOA-RM}{
		...
		See \GlossaryNameRef{capability-system} for a definition we consider equivalent.
	}
...
An \GlossaryHyperRef{entity}{entity} being part of a \GlossaryHyperRef{system}{system}, contributing to it facilitating its \GlossaryHyperRef{capability-system}{capabilities}.
Compare with \GlossaryNameRef{subsystem}.
	...
	\GlossaryNote{Note 1}{
		...
		If referring to a system being a constituent of a \GlossaryHyperRef{system-of-systems}{system-of-systems}, prefer use of the words ``system'' and ``subsystem''.
	}
...
The activity of sending or receiving \GlossaryHyperRef{message}{messages}.
...
A set of changeable \GlossaryHyperRef{property}{properties} that directly influence the \GlossaryHyperRef{capability-system}{capabilities} of a \GlossaryHyperRef{provider-service}{service provider}.
...
TODO: (Hardware components) A physical \GlossaryHyperRef{entity}{entity} capable of hosting \GlossaryHyperRef{system}{systems}.
