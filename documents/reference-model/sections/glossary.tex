...
A \GlossaryHyperRef{description}{description} of a \GlossaryHyperRef{design}{design}.

	\GlossaryNote{Note 1}{
		A design description is a form of \GlossaryHyperRef{metadata}{metadata}.
	}
...
Synonymous to \GlossaryNameRef{model-concrete}.

\GlossaryEntry{design-interface}{Design, Interface}
A \GlossaryHyperRef{model-concrete}{concrete model} of an \GlossaryHyperRef{interface}{interface}, specifying the \GlossaryHyperRef{protocol}{protocols} it supports. TODO
...
A \GlossaryHyperRef{device}{device} that provides sensors and actuators that together make up an interface through which a human can exchange messages with one or more \GlossaryHyperRef{system}{systems}.
...
The realization of a \GlossaryHyperRef{model-concrete}{concrete model} as a set of \GlossaryHyperRef{artifact}{artifacts}.
...
The attempt to excercise the \GlossaryHyperRef{capability}{capabilities} of a \GlossaryHyperRef{provider-service}{service provider} by sending a \GlossaryHyperRef{message}{message} to one of its \GlossaryHyperRef{function}{functions}.
...
\GlossaryHyperRef{data}{Data} that can be moved between the \GlossaryHyperRef{interface}{interfaces} of \GlossaryHyperRef{system}{systems}.
