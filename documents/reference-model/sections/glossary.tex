...
A \GlossaryHyperRef{stakeholder}{stakeholder} involved in the analysis or development of significant \GlossaryHyperRef{entity}{entities}, particularly with the ambition of facilitating \GlossaryHyperRef{property}{properties} or use cases that cannot be realized without refining, extending or replacing those entities.
See Section \ref{sec:reference-model:stakeholder}.
