...
A task, of any nature, that can be performed by a \GlossaryHyperRef{service provider}{provider-service}.
...
A provision of a \GlossaryHyperRef{service provider}{provider-service} that could exercise one or more of its \GlossaryHyperRef{capabilities}{capability} if triggered. TODO: Improve.
