...
\ref{sec:reference-model:system-of-systems:local-cloud}            & \textbf{\nameref{sec:reference-model:system-of-systems:local-cloud}}            & A \GlossaryHyperRef{cloud}{cloud} with a local \GlossaryHyperRef{boundary-cloud}{boundary} and local \GlossaryHyperRef{resource}{resources}.\\
...
\ref{sec:reference-model:interface}                                & \textbf{\nameref{sec:reference-model:interface}}                                & A point where \GlossaryHyperRef{message}{messages} pass between \GlossaryHyperRef{entity}{entities}, or an entity and a person.\\
