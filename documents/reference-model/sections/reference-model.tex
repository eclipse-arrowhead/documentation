...
Every device consists of \GlossaryHyperRef{component-hardware}{hardware components}, which are what concretely facilitate its capabilities.
While there are not limits to what components can make up a device, they must always have (1) \GlossaryHyperRef{unit-memory}{memory}, (2) \GlossaryHyperRef{unit-compute}{compute} and (3) \GlossaryHyperRef{interface-device}{interfacing} components, as shown in Figure \ref{fig:device}.
