...
\begin{center}
  ...
  \begin{abstract}
    This document provides authoritative definitions for the most fundamental concepts and ideas of relevance to \textit{Eclipse Arrowhead}, a framework designed to facilitate the effective creation of highly dynamic automation systems.
    The document is concerned with concept definitions only.
    It does not make any explicit recommendations how Arrowhead systems \textit{should} be design.
    While presented in the form of a model, the document does not in and of itself build upon or endorse any particular modeling framework.
  \end{abstract}
...
\label{sec:model}
\input{sections/reference-model}
