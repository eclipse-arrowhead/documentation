...
\begin{center}
  ...
  \begin{abstract}
    This document establishes fundamental concepts of relevance to \textit{Eclipse Arrowhead}, a framework designed to help create highly dynamic industrial systems.
    ...
    It makes no recommendations regarding how Arrowhead systems \textit{should} be designed.
  \end{abstract}
